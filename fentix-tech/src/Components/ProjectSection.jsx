...
const ProjectSection = () => {
  ...
  return (
    <section
      id="projects"
      className="relative w-full bg-white text-gray-900 py-20 px-4 sm:px-6 md:px-12 lg:px-16 overflow-hidden"
    >
      {/* BACKGROUND LAYER */}
            ...
            >
              ...
              <div className="relative overflow-hidden bg-white">
                <img
                  src={project.image}
                  alt={project.title}
                  className="w-full h-52 sm:h-56 md:h-60 object-cover bg-white
              ...
              <div className="flex flex-col flex-1 p-5 sm:p-6 bg-white">
                ...
                <p className="text-gray-600 text-xs sm:text-sm leading-relaxed my-3 sm:my-4">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-5 sm:mb-6">
                  {project.tech.map((item, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 rounded-full text-[11px] sm:text-xs bg-blue-50 text-blue-700 border border-blue-200"
                    >
                      {item}
                    </span>
                  ))}
                ...
                <button className="mt-auto w-full py-2.5 sm:py-3 rounded-xl bg-blue-700 hover:bg-blue-800 transition text-white font-medium text-sm sm:text-base">
                  View Details
                </button>
              </div>
            </div>
